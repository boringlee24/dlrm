...
do
    ...
    ./kaggle.sh $batch $num_batch $json_path "0-5,24-29" "--log-path=run_log/${batch}_diff_1.log" 
    sleep 10
done
for batch in 64 128 256 512
do
    json_path="inference_data/colocation/${batch}_diff_2.json"   
    ./kaggle.sh $batch $num_batch $json_path "6-11,30-35" "--log-path=run_log/${batch}_diff_2.log" 
    sleep 10
done
...
do
    ...
    ./kaggle.sh $batch $num_batch $json_path "0-11,24-35" "--log-path=run_log/${batch}_same.log" 
    sleep 10
done
